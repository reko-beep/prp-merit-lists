...
def get_merit_by_type(program_name: str, page: int):
    ...
    url = 'https://prp.phf.gop.pk/MeritGazat/MeritGetAllByTypeView'    
    print('https://prp.phf.gop.pk/phft/merit/list-'+TYPE_PROGRAM[program_name])
    ...
    headers= {
        'Referer': 'https://prp.phf.gop.pk/phft/merit/list-'+TYPE_PROGRAM[program_name],
...
def get_whole_merit(program_name: str , page: int):
    '''
